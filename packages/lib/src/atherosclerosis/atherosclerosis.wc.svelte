    ...
    onMount(async () => {
        ...
        if (res1 > mid1 || res2 < mid2 || res3 < mid3 || res4 < mid4 || res5 > mid5) {
            if ((res1 > mid1 && res2 < mid2 && res3 < mid3) ||
                ...
                (res1 > mid1 && res2 < mid2 && res5 > mid5) ||
                (res1 > mid1 && res3 < mid3 && res4 < mid4) ||
                (res1 > mid1 && res3 < mid3 && res5 > mid5) ||
                (res1 > mid1 && res4 < mid4 && res5 > mid5) ||
            ...
            <div class="summaryMain">
                ...
                <div class="summaryBody" style="opacity: 0.35;">
                    ...
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Pain in Legs or Arms:</b> Occurs when the blood flow to limbs is restricted, <br>
                        leading to muscle pain or cramping.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Shortness of Breath:</b> An indication that the heart is struggling to pump <br>
                        efficiently due to reduced arterial flow.</div>
                    <div style="font-size: 1.2rem; padding-top: 1.2rem;padding-bottom: 1rem;">Possible follow-up tests:</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Blood Tests:</b> To identify high cholesterol levels and inflammatory markers <br>
                        that contribute to plaque buildup.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Ankle Brachial Index:</b> Compares blood pressure in the ankle with the arm <br>
                        to check for peripheral artery disease.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Ultrasound or Angiography:</b> Visualizes the inside of arteries to detect <br>
                        areas of plaque accumulation and blockage.</div>
                </div>
            </div>
        {:else}
            <div class="summaryMain" style="border: 2px solid {getColor()};">
                ...
                <div class="summaryBody" style="background-color: {getBodyBackground()};">
                    ...
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Blood Tests:</b> To identify high cholesterol levels and inflammatory markers <br>
                        that contribute to plaque buildup.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Ankle Brachial Index:</b>  These tests can detect blood or certain DNA mutations <br>
...
{:else}
    <div class="main">
        ...
        <div class="lastRow">
            <div class="dot1"></div>
            <div style="font-size: 0.8rem;">Atherosclerosis</div>
            <div class="dot2"></div>
