      ...
      <div class="summaryMain">
        ...
        <div class="summaryBody" style="opacity: 0.35;">
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Diarrhea with blood or pus:</b> Inflammation in the colon and rectum leads to <br />
            diarrhea, often accompanied by blood or pus.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Abdominal pain and cramping:</b> Inflammation and ulcers in the colon cause <br />
    ...
    {:else}
      <div class="summaryMain" style="border: 2px solid {getColor()};">
        ...
        >
          ...
          <div style="width: 90%;">
            There is <b>{getWording()}</b> of glycan indexes between <br /> your patient and ulcerative
            colitis patients.
          </div>
        </div>
