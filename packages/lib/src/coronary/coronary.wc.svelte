...
<script lang="ts">
    ...
    onMount(async () => {
        ...
        mid2 =  Number(reportData.Sxaverage);
            ...
            <div class="summaryMain">
                ...
                <div class="summaryBody" style="opacity: 0.35;">
                    ...
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Nausea or Fatigue:</b> Women may experience these symptoms more often <br>
                        than men due to heart strain.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Shortness of Breath:</b> A sign of heart struggling to pump effectively, not <br>
                        necessarily accompanied by chest pain.</div>
                    <div style="font-size: 1.2rem; padding-top: 1.2rem;padding-bottom: 1rem;">Possible follow-up tests:</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>EKG/ECG:</b> Detects electrical abnormalities in the heart that can arise from <br>
                        reduced coronary blood flow.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Stress Test:</b> Assesses how the heart functions under stress, can reveal hidden <br>
                        problems with blood flow.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Coronary Angiography:</b> Directly visualizes the coronary arteries to identify <br>
                        any blockages or narrowing.</div>
                </div>
            </div>
        {:else}
...
{:else}
    <div class="main">
        ...
        <div class="lastRow">
            <div class="dot1"></div>
            <div style="font-size: 0.8rem;">Coronary artery disease</div>
            <div class="dot2"></div>
