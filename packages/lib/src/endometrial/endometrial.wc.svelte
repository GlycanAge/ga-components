...
{:else if type === 'summary' && showSummary}
    <div class="summaryMain">
        ...
        <div class="summaryBody">
            ...
            <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7333120/">Serum immunoglobulin G N-glycome: a potential biomarker in endometrial cancer</a>
            <p>A total of 94 EC patients and 112 healthy females were recruited and sorted into an EC cohort and a control cohort. Serum samples were obtained from every participant, and IgG N-glycome profiling was conducted using ultra-performance liquid chromatography (UPLC).</p>
        </div>
    </div>
{:else}
    {#if subtype === 'mature'}
