<svelte:options customElement={{ tag: 'ga-endometrial', shadow: 'open' }} />
      ...
      <div class="summaryMain">
        ...
        <div class="summaryBody" style="opacity: 0.35;">
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Abnormal vaginal bleeding:</b> Unusual vaginal bleeding, especially postmenopausal
            <br /> bleeding, may indicate endometrial cancer.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Pelvic pain:</b> Persistent pain in the pelvic area can be a sign of endometrial
            <br />
            cancer.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Unintended weight loss:</b> Sudden and unexplained weight loss may be associated
            <br /> with cancer progression.
          </div>
          <div style="font-size: 1.2rem; padding-top: 1.2rem;padding-bottom: 1rem;">
            Possible follow-up tests:
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Transvaginal ultrasound:</b>This imaging test helps visualize the endometrium <br /> and
            assess for abnormalities.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Endometrial biopsy:</b> Taking a sample of endometrial tissue helps in diagnosing
            <br /> cancer.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Computed tomography (CT) scan:</b> This test can help determine the cancer's <br />
            stage and spread.
          </div>
        </div>
      </div>
    {:else}
      <div class="summaryMain" style="border: 2px solid {getColor()};">
        ...
        >
          ...
          <div style="width: 90%;">
            There is <b>{getWording()}</b> of glycan indexes <br /> between your patient and endometrial
            cancer patients.
          </div>
        </div>
...
{:else}
  <div class="main">
    ...
    <div class="lastRow">
      <div class="dot1"></div>
      <div style="font-size: 0.8rem;">Endometrial cancer</div>
      <div class="dot2"></div>
