      ...
      <div class="summaryMain">
        ...
        <div class="summaryBody" style="opacity: 0.35;">
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Diarrhea:</b> Persistent inflammation in the digestive tract often leads to frequent
            <br /> diarrhea.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Abdominal pain and cramping:</b> Inflammation and ulcers may cause significant <br />
            abdominal discomfort.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Weight loss:</b> Nutrient malabsorption due to inflammation can result in unintended
            <br /> weight loss.
          </div>
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Colonoscopy:</b> A colonoscopy allows for a detailed examination of the entire <br />
            colon and the terminal ileum.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>CT or MRI scan:</b> These imaging studies can provide detailed images of the
            digestive <br /> system.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Biopsy:</b> Tissue samples can be taken to confirm the diagnosis and assess <br />
            inflammation.
          </div>
        </div>
      </div>
    {:else}
      <div class="summaryMain" style="border: 2px solid {getColor()};">
        ...
        >
          ...
          <div style="width: 90%;">
            There is <b>{getWording()}</b> of glycan indexes between <br /> your patient and Crohn’s
            disease patients.
          </div>
        </div>
