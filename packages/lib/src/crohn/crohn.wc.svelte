<svelte:options customElement={{tag: "ga-crohn",shadow: "open",}}/>
            ...
            <div class="summaryMain">
                ...
                <div class="summaryBody" style="opacity: 0.35;">
                    ...
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Abdominal pain and cramping:</b> Inflammation and ulcers may cause
                        significant <br> abdominal discomfort.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Weight loss:</b>  Nutrient malabsorption due to inflammation can result in
                        unintended <br> weight loss.</div>
                    <div style="font-size: 1.2rem; padding-top: 1.2rem;padding-bottom: 1rem;">Possible follow-up tests:</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Colonoscopy:</b>  A colonoscopy allows for a detailed examination of the entire <br>
                        colon and the terminal ileum.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>CT or MRI scan:</b> These imaging studies can provide detailed images of the
                        digestive <br> system.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Biopsy:</b>  Tissue samples can be taken to confirm the diagnosis and assess <br>
                        inflammation.</div>
                </div>
            </div>
        {:else}
...
{:else}
    <div class="main">
        ...
        <div class="lastRow">
            <div class="dot1"></div>
            <div style="font-size: 0.8rem;">Crohn's Disease</div>
            <div class="dot2"></div>
