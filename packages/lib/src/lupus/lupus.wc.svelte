      ...
      <div class="summaryMain">
        ...
        <div class="summaryBody" style="opacity: 0.35;">
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Fatigue:</b> Overactive immune responses lead to chronic exhaustion.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Joint pain and swelling:</b> Inflammation from the immune attack affects the joints.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Skin rash:</b> Particularly a butterfly-shaped rash on the face, indicating skin
            <br />
            inflammation.
          </div>
          <div style="font-size: 1.2rem; padding-top: 2rem;padding-bottom: 1rem;">
...
{:else}
  <div class="main">
    <div class="row">
      <div class="label"><b>Peak 18</b></div>
      <div class="content">
    ...
    <div class="row">
      <div class="label"><b>Peak 23</b></div>
      <div class="content">
    ...
    <div class="row">
      <div class="label"><b>Peak 26</b></div>
      <div class="content">
