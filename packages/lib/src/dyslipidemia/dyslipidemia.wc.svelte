...
<script lang="ts">
    ...
    onMount(async () => {
        ...
        mid2 =  Number(reportData.G2xaverage);
        ...
        mid3 =  Number(reportData.Sxaverage);
        ...
        {#if noOverlap}
            <div class="summaryMain">
                <div class="summaryHeader" style="border-radius: 8px; background-color: rgba(0,170,68,0.15); border: 2px solid #00AA44;">
                    ...
                    <div style="width: 90%;">There is <b>no significant overlap</b> of glycan indexes between <br> your patient and dyslipidemia patients.</div>
                </div>
                <div class="summaryBody" style="opacity: 0.35;">
                    <div style="font-size: 1.2rem; padding-bottom: 1rem;">Symptoms to check for:</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Asymptomatic Nature:</b> Dyslipidemia often shows no physical symptoms, <br>
                        identified usually through routine blood tests.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Xanthomas:</b>  Fatty deposits under the skin, particularly around the eyelids, <br>
                        indicating elevated lipid levels.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Chest Pain or Heart Complications:</b> In severe cases, high lipid levels can <br>
                        lead to coronary artery disease, manifesting as chest pain.</div>
                    <div style="font-size: 1.2rem; padding-top: 1.2rem;padding-bottom: 1rem;">Possible follow-up tests:</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Lipid Panel:</b> Essential for measuring total cholesterol, LDL, HDL, and <br>
                        triglycerides, to assess the severity of dyslipidemia.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Genetic Testing:</b> To determine if dyslipidemia is hereditary, especially in <br>
                        cases of familial hypercholesterolemia.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Liver Function Tests:</b> Important as the liver plays a key role in lipid <br>
                        metabolism; abnormalities can indicate secondary effects of dyslipidemia.</div>
                </div>
            </div>
        {:else}
            <div class="summaryMain" style="border: 2px solid {getColor()};">
                <div class="summaryHeader" style="border-radius: 8px 8px 0 0; background-color: {getBackground()}; border-bottom: 2px solid {getColor()};">
                    ...
                    <div style="width: 90%;">There is <b>{getWording()}</b> of glycan indexes between <br> your patient and dyslipidemia patients.</div>
                </div>
                <div class="summaryBody" style="background-color: {getBodyBackground()};">
                    ...
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Genetic Testing:</b> To determine if dyslipidemia is hereditary, especially in <br>
                        cases of familial hypercholesterolemia.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Liver Function Tests:</b> Important as the liver plays a key role in lipid <br>
                        metabolism; abnormalities can indicate secondary effects of dyslipidemia.</div>ov
                </div>
            </div>
        {/if}
    {/if}
