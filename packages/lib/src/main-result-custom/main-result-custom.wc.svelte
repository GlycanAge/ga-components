<svelte:options customElement={{ tag: 'ga-main-result-custom', shadow: 'open' }}/>
    ...
    <div class="graph-container">
      <div class="slider">
        <div class="slider-pin" style="left: {calc()}%;">
          <svg width="30" height="38" viewBox="0 0 44 52" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <b class="slider-number" style="font-size: 0.7rem;">{glycanage}</b>
        </div>
      </div>
