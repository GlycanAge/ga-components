...
{:else if type === 'summary' && showSummary}
    <div class="summaryMain">
        ...
        <div class="summaryBody">
            ...
            <ul>
                <li>Stool-based tests: these tests can detect blood or certain DNA mutations in the stool that may indicate cancer</li>
                <li>Colonoscopy</li>
                <li>CT colonography</li>
            </ul>
            <h5>Related research papers</h5>
            <a href="https://pubmed.ncbi.nlm.nih.gov/33599092/">Revealing the changes of IgG subclass-specific N-glycosylation in colorectal cancer progression by high-throughput assay</a>
            <p>Through the simple and high-throughput procedures, this study revealed the important role of IgG glycopeptides in the premature pathology of CRC.</p>
            <a href="https://pubmed.ncbi.nlm.nih.gov/31846768/">Comprehensive analysis of human IgG Fc N-glycopeptides and construction of a screening model for colorectal cancer</a>
            <p>By using the IgG N-glycopeptide enrichment method and screening model designed in this study, early large-scale colorectal cancer screening can be implemented easily and fast.</p>
            <a href="https://pubmed.ncbi.nlm.nih.gov/27302279/">Glycosylation of plasma IgG in colorectal cancer prognosis</a>
            <p>This study demonstrates the potential value of Immunoglobulin G (IgG) glycosylation as a novel prognostic biomarker of colorectal cancer (CRC).</p>
            <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5860729/">Immunoglobulin G glycome in colorectal cancer</a>
            <p>This study compares IgG glycosylation in 760 patients with colorectal cancer (CRC) with that in 538 age and sex matched healthy controls.</p>
        </div>
    </div>
{:else}
    {#if subtype === 'mature'}
