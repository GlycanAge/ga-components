      ...
      <div class="summaryMain">
        ...
        <div class="summaryBody" style="opacity: 0.35;">
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Changes in bowel habits:</b> Cancer in the colon or rectum can cause alterations
            <br /> in bowel habits.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Rectal bleeding or blood in stool:</b> The growth of cancerous cells in the colon
            <br /> can lead to blood in the stool.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Abdominal discomfort:</b> Cancer in the colorectal region can cause abdominal <br /> pain,
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Colonoscopy:</b> A colonoscopy can visually inspect the interior of the colon <br />
            for polyps or cancer.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Stool-based tests:</b> These tests can detect blood or certain DNA mutations <br />
            in the stool that may indicate cancer.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>CT colonography:</b> This imaging test provides a detailed view of the colon <br /> to
            identify polyps or cancer.
          </div>
        </div>
      </div>
    {:else}
      <div class="summaryMain" style="border: 2px solid {getColor()};">
        ...
        >
          ...
          <div style="width: 90%;">
            There is <b>{getWording()}</b> of glycan indexes between <br /> your patient and colorectal
            cancer patients.
          </div>
        </div>
