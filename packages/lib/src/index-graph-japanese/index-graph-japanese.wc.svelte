<svelte:options customElement={{ tag: 'ga-index-graph-japanese', shadow: 'open' }}/>

<script lang="ts">
    import {onMount} from 'svelte';
    import {Service} from '../shared/utils/service';
    import {calculateSliderPosition, getColorBlueToRed, getColorRedToBlue} from '../shared/functions/helpers';
