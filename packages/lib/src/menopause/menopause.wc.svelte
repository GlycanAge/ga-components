      ...
      <div class="summaryMain">
        ...
        <div class="summaryBody" style="opacity: 0.35;">
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Irregular periods:</b> Hormonal fluctuations during perimenopause lead to changes in
            <br />menstrual cycle patterns.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Hot flashes:</b> Sudden feelings of warmth, usually in the upper body, are caused
            <br />by hormonal changes.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Sleep disturbances:</b> Hormonal changes during this period can lead to sleep<br />
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Hormone testing:</b>Blood tests measuring hormone levels can help in assessing <br />
            menopausal status.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Bone density test:</b> This test assesses the risk of osteoporosis, which increases
            <br /> post-menopause.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Cholesterol and blood pressure check:</b> These are important to evaluate <br />
    ...
    {:else}
      <div class="summaryMain" style="border: 2px solid {getColor()};">
        ...
        >
          ...
          <div style="width: 90%;">
            There is <b>{getWording()}</b> of glycan indexes <br /> between your patient and perimenopausal
            women.
          </div>
        </div>
