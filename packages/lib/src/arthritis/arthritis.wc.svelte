...
<script lang="ts">
    ...
    let res1 = 0.177; // G0yourscore
    let perc1 = 77; // G0percentile

    let min2 = 0.091; // G1xmin
    let max2 = 0.216; // G1xmax
    let mid2 = 0.150;  // G1xaverage
    let res2 = 0.111; // G1yourscore
    let perc2 = 11; // G1percentile

    let min3 = 0.109; // G2xmin
    let max3 = 0.175; // G2xmax
    let mid3 = 0.141; //G2xaverage
    let res3 = 0.145; // G2yourscore
    let perc3 = 51; // G2percentile
