<svelte:options customElement={{ tag: 'ga-biological-age-rank-d2c', shadow: 'open' }}/>
...
{#if show}
  <div class="main">
    <div class="label">
      <span>When compared to your peers, your<br>biological age ranks in the <span style="color: {getColorBlueToRedWithPercentile(percentile)};"><b>{percentile}<sup>{suffix(percentile, "english")}</sup></b></span> percentile.</span>
    </div>
    <div class="graph">
