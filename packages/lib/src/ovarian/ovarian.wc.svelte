    ...
    <div class="summaryMain" style="border: 2px solid {getColor()};">
        ...
        <div class="summaryBody">
            ...
            <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Quickly feeling full when eating:</b>  Ovarian cancer may cause a loss of
                appetite <br> or feeling full rapidly.</div>
            <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Pelvic or abdominal pain:</b> Chronic pain in the pelvic or abdominal area is <br> a
                common symptom.</div>
            <div style="font-size: 1.2rem; padding-top: 1.2rem;padding-bottom: 1rem;">Possible follow-up tests:</div>
            <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Transvaginal ultrasound:</b> This imaging can help detect masses or tumors in <br>
                the ovaries.</div>
            <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>CA-125 blood test:</b> Elevated levels of CA 125 may be indicative of ovarian cancer.</div>
            <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Biopsy:</b>  Tissue samples can confirm the diagnosis of ovarian cancer.</div>
        </div>
    </div>
{:else}
    <div class="main">
        ...
        <div class="lastRow">
            <div class="dot1"></div>
            <div style="font-size: 0.8rem;">Ovarian cancer</div>
            <div class="dot2"></div>
