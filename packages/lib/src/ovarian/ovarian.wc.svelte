      ...
      <div class="summaryMain">
        ...
        <div class="summaryBody" style="opacity: 0.35;">
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Abdominal bloating or swelling:</b> Persistent bloating may be a sign of ovarian
            <br /> cancer.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Quickly feeling full when eating:</b> Ovarian cancer may cause a loss of appetite
            <br /> or feeling full rapidly.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Pelvic or abdominal pain:</b> Chronic pain in the pelvic or abdominal area is <br /> a
            common symptom.
          </div>
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Transvaginal ultrasound:</b> This imaging can help detect masses or tumors in <br />
            the ovaries.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>CA-125 blood test:</b> Elevated levels of CA 125 may be indicative of ovarian cancer.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Biopsy:</b> Tissue samples can confirm the diagnosis of ovarian cancer.
          </div>
        </div>
      </div>
    {:else}
      <div class="summaryMain" style="border: 2px solid {getColor()};">
        ...
        >
          ...
          <div style="width: 90%;">
            There is <b>{getWording()}</b> of glycan indexes between <br /> your patient and ovarian
            cancer patients.
          </div>
        </div>
