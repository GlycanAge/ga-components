...
<script lang="ts">
    ...
    let min1 = 0; // G2xmin
    let max1 = 0; // G2xmax
    let res1 = 0; // G2yourscore
    let perc1 = 0; // G2percentile
    ...
    onMount(async () => {
        ...
        min1 = Number(reportData.G2xmin);
        max1 = Number(reportData.G2xmax);
        res1 = Number(reportData.G2yourscore);
        perc1 = Number(reportData.G2percentile);
        ...
        {#if noOverlap}
            <div class="summaryMain">
                ...
                >
                    ...
                    <div style="width: 90%;">
                        There is <b>no significant overlap</b> of glycan indexes between <br /> your patient and pre-hypertension patients.
                    </div>
                </div>
                <div class="summaryBody" style="opacity: 0.35;">
                    ...
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
                        <b>No notable symptoms:</b> Often, pre-hypertension has no apparent symptoms, <br />
                        making regular blood pressure checks vital.
                    </div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
                        <b>Mild headaches or dizziness:</b> Occasionally, individuals might experience <br />
                        mild headaches or dizziness, which can be early signs. <br />
                    </div>
                    ...
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
                        <b>Lifestyle assessment:</b> Evaluating diet, physical activity, and other lifestyle
            ...
            <div class="summaryMain" style="border: 2px solid {getColor()};">
                ...
                >
                    ...
                    <div style="width: 90%; font-size: 0.8rem;">
                        There is <b>{getWording()}</b> of glycan indexes between <br /> your patient and pre-hypertension patients.
                    </div>
                </div>
...
{:else}
    <div class="main" style="height: 180px;">
        <div class="row" style="height: 30%; padding-bottom: 1rem;">
            <div class="label" style="font-size: 0.8rem;">Glycan<br /><b>Youth</b></div>
            <div class="content">
        ...
        <div class="lastRow">
            <div class="dot1"></div>
            <div style="font-size: 0.8rem;">Pre-hypertension</div>
            <div class="dot2"></div>
