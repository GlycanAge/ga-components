<svelte:options customElement={{ tag: 'ga-diabetes', shadow: 'open' }} />
      ...
      <div class="summaryMain">
        ...
        >
          ...
          <div style="width: 90%;">
            ...
            type 2 diabetes disease patients.
          </div>
        </div>
        <div class="summaryBody" style="opacity: 0.35;">
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Increased thirst and frequent urination:</b> Elevated blood sugar levels lead to
            <br /> increased fluid loss through urination, causing thirst and dehydration.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Fatigue:</b> Lack of sufficient energy from glucose can cause tiredness and fatigue.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Blurred vision:</b> High blood glucose levels can affect the eyes, leading to blurry
            <br /> vision.
          </div>
          ...
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>HbA1c test:</b> This blood test provides information about average blood glucose
            <br /> levels over the past 3 months.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Fasting blood sugar test:</b> It measures the blood glucose levels after an overnight
            <br /> fast to assess the body s glucose regulation.
          </div>
          <div style="font-size: 0.7rem; padding-bottom: 0.4rem;">
            <b>Oral glucose tolerance test (OGTT):</b> This assesses the body s response to <br />
            glucose to determine insulin resistance and diabetes.
          </div>
        </div>
      </div>
    {:else}
      <div class="summaryMain" style="border: 2px solid {getColor()};">
        ...
        >
          ...
          <div style="width: 90%;">
            There is <b>{getWording()}</b> of glycan indexes between <br /> your patient and type 2 diabetes
            disease patients.
          </div>
        </div>
...
{:else}
  <div class="main">
    ...
    <div class="lastRow">
      <div class="dot1"></div>
      <div style="font-size: 0.8rem;">Type 2 diabetes</div>
      <div class="dot2"></div>
