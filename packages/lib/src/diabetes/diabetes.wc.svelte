        ...
        {#if noOverlap}
            <div class="summaryMain">
                ...
                <div class="summaryBody" style="opacity: 0.35;">
                    ...
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Blurred vision:</b>  High blood glucose levels can affect the eyes, leading to
                        blurry <br> vision.</div>
                    <div style="font-size: 1.2rem; padding-top: 1.2rem;padding-bottom: 1rem;">Possible follow-up tests:</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>HbA1c test:</b>  This blood test provides information about average blood
                        glucose <br> levels over the past 3 months.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Fasting blood sugar test:</b>  It measures the blood glucose levels after an
                        overnight <br> fast to assess the body s glucose regulation.</div>
                    <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Oral glucose tolerance test (OGTT):</b>  This assesses the body s response to <br>
                        glucose to determine insulin resistance and diabetes.</div>
                </div>
            </div>
        {:else}
