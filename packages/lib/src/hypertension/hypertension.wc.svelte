...
<script lang="ts">
    ...
    let res2 = 0.170; // G1yourscore
    let perc2 = 30; // G1percentile

    // youth
    let min3 = 0.109; // G2xmin
    let max3 = 0.175; // G2xmax
    let mid3 = 0.140; //G2xaverage
    let res3 = 0.112; // G2yourscore
    let perc3 = 12; // G2percentile

    // lifestyle
    let min4 = 0.109; // Bxmin
    let max4 = 0.175; // Bxmax
    let mid4 = 0.140; //Bxaverage
    let res4 = 0.133; // Byourscore
    let perc4 = 11; // Bpercentile
    ...
    function getColor() {
        if (res4 < mid4 && res3 < mid3 && res1 > mid1 && res2 < mid2 && res3 < mid3) {
            return '#d90202';
        }
        if (res4 < mid4 || res3 < mid3 || res1 > mid1 || res2 < mid2 || res3 < mid3) {
            return 'darkorange';
...
{:else if type === 'summary'}
    <div class="summaryMain" style="border: 2px solid {getColor()};">
        ...
        <div class="summaryBody">
            ...
            <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Blood pressure monitoring:</b>  Regular blood pressure checks can accurately <br> monitor hypertension levels.</div>
            <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Blood tests:</b>  These assess cholesterol levels and other factors related to <br> hypertension.</div>
            <div style="font-size: 0.7rem; padding-bottom: 0.4rem;"><b>Electrocardiogram (EKG or ECG):</b>  This test can identify issues with heart <br> rhythm or damage related to hypertension.</div>
        </div>
    </div>
{:else}
    <div class="main">
        ...
        <div class="lastRow">
            <div class="dot1"></div>
            <div style="font-size: 0.8rem;">Hypertension</div>
            <div class="dot2"></div>
            <div style="font-size: 0.8rem;">Your patient</div>
        </div>
        <div style="position: absolute; top: 3%; left: 5.5%; font-size: 0.6rem;"><b>1. Increased risk of hypertension</b></div>
        <div style="position: absolute; top: 23%; left: 5.5%; font-size: 0.6rem;"><b>2. Pre-hypertension</b></div>
        <div style="position: absolute; top: 25%; left: 0; font-size: 0.7rem; height: 2px; width: 4%; background-color: #C8DBD0;"><b></b></div>
        <div style="position: absolute; top: 25%; right: 0; font-size: 0.7rem; height: 2px; width: 70%; background-color: #C8DBD0;"><b></b></div>
        <div style="position: absolute; top: 46%; left: 0; font-size: 0.7rem; height: 2px; width: 4%; background-color: #C8DBD0;"><b></b></div>
        <div style="position: absolute; top: 46%; right: 0; font-size: 0.7rem; height: 2px; width: 75%; background-color: #C8DBD0;"><b></b></div>
        <div style="position: absolute; top: 44%; left: 5.5%; font-size: 0.6rem;"><b>3. Hypertension</b></div>
    </div>
{/if}
